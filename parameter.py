...
def get_parameters():
    ...
    parser.add_argument('--version', type=str, default='sagan_infra')

    # Training setting
    parser.add_argument('--total_step', type=int, default=30000, help='how many times to update the generator')
    ...
    parser.add_argument('--dataset', type=str, default='infra', choices=['lsun', 'celeb', 'infra'])
